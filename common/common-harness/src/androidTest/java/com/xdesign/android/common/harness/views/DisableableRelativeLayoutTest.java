...
import com.xdesign.android.common.lib.views.DisableableRelativeLayout;
...
public final class DisableableRelativeLayoutTest {
            ...
            new FixedActivityTestRule<ViewTestingActivity>(ViewTestingActivity.class) {
                ...
                protected Intent getActivityIntent() {
                    return ViewTestingActivity.create(
                            ...
                            R.layout.disableable_relative_layout);
                }
            };

    private DisableableRelativeLayout uut;

    @Before
    public void before() {
        uut = (DisableableRelativeLayout) rule.getActivity().findViewById(
                R.id.disableable_relative_layout);
    }
