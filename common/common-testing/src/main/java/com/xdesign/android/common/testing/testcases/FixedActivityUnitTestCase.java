...
/**
 * Basically a copy of {@link android.test.ActivityUnitTestCase} which fixes an
 * issue around activities being started up using a wrong context for the
 * component.
 */
@SuppressWarnings("all")
public class FixedActivityUnitTestCase<T extends Activity> extends
        ActivityTestCase {
    ...
    public FixedActivityUnitTestCase(Class<T> activityClass) {
    ...
    protected T startActivity(Intent intent, Bundle savedInstanceState,
        ...
        if (!mAttached) {
            ...
            try {
                ...
                ComponentName cn = new ComponentName(getInstrumentation().getTargetContext(),
                        mActivityClass);
     ...
     * {@link android.app.Activity#startActivity(android.content.Intent)} or
     ...
     * {@link android.app.Activity#finishFromChild(android.app.Activity)}, or
     ...
     * <li>{@link android.app.Activity#finishFromChild(android.app.Activity child)}</li>
     * </ul>
     */
    private static class MockParent extends Activity {
         ...
         * <ul>
         * <li>{@link android.app.Activity#startActivity(android.content.Intent)}</li>
